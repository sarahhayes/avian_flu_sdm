...
Training set A: 10/8/2016 to 9/8/2020 (H5NX records before 2020/21 outbreak, including 2016/2017 H5N8 outbreak; all H5 subtypes)
Test set A: 10/8/2020 to 9/8/2021 (2020/21 H5N8 outbreak; all H5 subtypes)
 
Training set B: 10/8/2021 to 28/2/2023 (start of ongoing 2021- H5N1 outbreak; H5N1 and unlabelled/ambiguous records)
Test set B: 28/2/2023 to 29/2/2024 (most recent complete calendar year of ongoing 2021- H5N1 outbreak at time of study; H5N1 and unlabelled/ambiguous records)

Raw records are plotted in time and space as `data_fig.png`, before stratifying by bird behavioural season and assigning cells on a 10km^2 grid as either positives (regardless of number of influenza records) or negatives.
