...
lc_lookup <- pairlist("lc_1" = "Evergreen_Needleleaf_Forests",
                      "lc_2" = "Evergreen_Broadleaf_Forests",
                      "lc_3" = "Deciduous_Needleleaf_Forests",
                      "lc_4" = "Deciduous_Broadleaf_Forests",
                      "lc_5" = "Mixed_Forests",
                      "lc_6" = "Closed_Shrublands",
                      "lc_7" = "Open_Shrublands",
                      "lc_8" = "Woody_Savannas",
                      "lc_9" = "Savannas",
                      "lc_10" = "Grasslands",
                      "lc_11" = "Permanent_Wetlands",
                      "lc_12" = "Croplands",
                      "lc_13" = "Urban_and_Built-up_Lands",
                      "lc_14" = "Cropland/Natural_Vegetation_Mosaics",
                      "lc_15" = "Permanent_snow/ice",
