...
#SBATCH -o bart_fits_with_ri.%u.%N.%j.out
# Define a standard error file
#SBATCH -e bart_fits_with_ri.%u.%N.%j.err
...
Rscript bart_scripts/fit_avian_flu_model_with_ri.R "volatile/" "no-crossterms" "TRUE"
