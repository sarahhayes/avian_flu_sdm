...
## modifying to see if I can get to work as I want
...
# the example data currently shows only the US state of Michigan. Do Europe instead
...
plot(wh_europe, col = "#cfcfcf", border = NA, add = TRUE)
...
# country boundaries
plot(wh_europe, add = TRUE, col = NA, border = "white", lwd = 1.5)
