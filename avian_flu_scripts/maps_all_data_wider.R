...
euro_map_small_extent <- terra::ext(2600000, 7000000, 1550000, 6400000)
euro_map_small <- terra::crop(euro_map, euro_map_small_extent)

pdf("plots/alldata_pos_map.pdf", width = 7, height = 9)
plot(euro_map_small, col = "white", background = "azure2", main = "All positive")
plot(pts_bvbrc_pos, add = T, col = "red", pch = 20, cex = 0.5)
plot(pts_fao, add= T, col = 'red', pch = 20, cex = 0.5)
plot(pts_woah, add = T, col = "red", pch = 20, cex = 0.5)
dev.off()
